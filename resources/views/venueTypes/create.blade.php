...
@section('title', 'Create Venue Type')
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-sm-6 col-sm-push-3">
                    <form role="form" method="post" action="{{route('venue_type.create')}}" enctype = "multipart/form-data">
                        {{ csrf_field() }}
                        @if ($errors->any())
                        ...
                        <div class="form-group{{ $errors->has('type_name') ? ' has-error' : '' }}">
                            ...
                            <input name="type_name" value="{{ old('type_name') }}" type="text" class="form-control" placeholder="Enter ..." required>
