...
@section('content')
        ...
        <form role="form" method="post" action="{{route('venue.create')}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-8">
                    <!-- create manager form -->
                                    ...
                                    <div class="form-group{{ $errors->has('venue_type') ? ' has-error' : '' }}">
                                        ...
                                        <select name="venue_type" class="form-control" required>
                                            ...
                                            @foreach($venueTypes as $venueType)
                                                <option value="{{$venueType->id}}" @if(old('venue_type') == $venueType->id) selected @endif>{{$venueType->name}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    ...
                                    <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                        <label>Address</label>
                                        <input name="address" value="{{old('address')}}" type="text" class="form-control" placeholder="Enter ..." required>
                                ...
                                <!-- text input -->
                                    <div class="form-group{{ $errors->has('ward') ? ' has-error' : '' }}">
                                        <label>Ward</label>
                                        <input name="ward" value="{{old('ward')}}" type="text" class="form-control" placeholder="Enter ..." required>
                                        @if ($errors->has('ward'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('ward') }}</strong>
                                            </span>
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <div class="form-group{{ $errors->has('longitude') ? ' has-error' : '' }}">
                                        ...
                                        <input name="longitude" value="{{old('longitude')}}" type="text" class="form-control" placeholder="Enter ..."
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group{{ $errors->has('latitude') ? ' has-error' : '' }}">
                                        ...
                                        <input name="latitude" value="{{old('latitude')}}" type="text" class="form-control" placeholder="Enter ..."
                                               maxlength="20" required>
