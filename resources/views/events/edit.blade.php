...
@section('content')
    ...
    <form role="form" method="post" action="{{route('event.edit',['id'=>$event->id])}}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-md-8">
                <!-- create manager form -->
                <div class="box box-success">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                    <label>Title</label>
                                    <input name="title" value="{{$event->title}}" type="text" class="form-control" placeholder="Enter ..." required>
                                    @if ($errors->has('title'))
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="form-group{{ $errors->has('sub_title') ? ' has-error' : '' }}">
                                    ...
                                    <input name="sub_title" value="{{$event->sub_title}}" type="text" class="form-control" placeholder="Enter ..." required>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group group__gender">
                                    ...
                                    <div class="radio-inline">
                                        <label>
                                            <input type="radio" value="Public" name="status" @if($event->status == 'Public') checked @endif>
                                            Public
                                        </label>
                                    </div>
                                    <div class="radio-inline">
                                        <label>
                                            <input type="radio" value="Un Public" name="status" @if($event->status == 'Un Public') checked @endif>
                                            Un Public
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control date" name="start_date" value="{{$event->start_date}}"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control date" name="end_date" value="{{$event->end_date}}"
                                           placeholder="dd/mm/yyyyy" type="text" autocomplete="off" required/>
                                </div>
                            </div>
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" placeholder="Enter..." rows="5">{{$event->description}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-footer">
                        <input id="imgHandleInput" name="image" type="file" value="{{$event->image}}">
            ...
            <div class="col-md-4">
                ...
                <div class="box box-warning">
                    <div class="box-body">
                        ...
                        <span>
                            <img id="imgHandle" src="{{asset(Utils::$PATH__IMAGE)}}/{{$event->image}}">
